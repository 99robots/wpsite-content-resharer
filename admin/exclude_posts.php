<div class="nnr-wrap">
	...
	<div class="nnr-container">
		...
		<div class="nnr-content">
			...
			<h1 id="nnr-heading"><?php _e('Exclude Posts', WPSITE_TWITTER_RESHARE_PLUGIN_TEXT_DOMAIN); ?></h1>
			...
			<form method="post" id="wpsite_twitter_reshare_exclude_posts_form" class="form-horizontal">
				...
				<div class="form-group">
					<label for="wpsite_twitter_reshare_exclude_posts_category" class="col-sm-3 control-label"><?php _e('Category', WPSITE_TWITTER_RESHARE_PLUGIN_TEXT_DOMAIN); ?></label>
					<div class="col-sm-9">
				...
				foreach ($posts as $post) {
					...
					<div class="form-group wpsite_twitter_reshare_exclude_posts_general <?php foreach ($post_categories as $cat) { echo 'wpsite_twitter_reshare_cat_' . $cat . ' '; } ?>">
						<label for="wps_settings_exclude_posts_<?php echo $post->ID; ?>" class="col-sm-3 control-label"><?php _e($post->post_title, WPSITE_TWITTER_RESHARE_PLUGIN_TEXT_DOMAIN); ?></label>
					    <div class="col-sm-9">
